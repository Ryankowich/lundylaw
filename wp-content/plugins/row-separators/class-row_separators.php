...
&lt;path class='gambit_sep_main' d='M-8,100c0,0,197-74,406-74s604,170,800,170s412-96,412-96v110H-8V100z'/></pre>",
		...
		public function renderShortcode( $atts, $content = null ) {
			...
			wp_enqueue_style( __CLASS__, plugins_url( 'row_separators/css/style.css', __FILE__ ), array(), VERSION_GAMBIT_ROW_SEPARATORS );
			wp_enqueue_script( __CLASS__, plugins_url( 'row_separators/js/min/script-min.js', __FILE__ ), array( 'jquery' ), VERSION_GAMBIT_ROW_SEPARATORS, true );
			...
			if ( $atts['separator'] == 'custom' && ! empty( $atts['custom_svg'] ) ) {
			...
			$viewBoxHeight = (int) $svgs[ $atts['separator'] ]['height'];// - 1;
			$viewBoxWidth = (int) $svgs[ $atts['separator'] ]['width'];// - 1;
